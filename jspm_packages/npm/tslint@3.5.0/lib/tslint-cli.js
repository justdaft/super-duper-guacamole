...
(function(process) {
  ...
  var processed = optimist.usage("Usage: $0 [options] [file ...]").check(function(argv) {
    ...
    "test": {describe: "test that tslint produces the correct output for the specified directory"},
    "v": {
      alias: "version",
