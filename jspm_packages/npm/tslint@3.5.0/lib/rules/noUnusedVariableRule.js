...
var NoUnusedVariablesWalker = (function(_super) {
  ...
  NoUnusedVariablesWalker.prototype.visitSourceFile = function(node) {
    ...
    if (this.hasOption(OPTION_REACT) && this.reactImport != null && !this.isReactUsed && !this.hasSeenJsxElement) {
  ...
  NoUnusedVariablesWalker.prototype.visitParameterDeclaration = function(node) {
    ...
    if (this.hasOption(OPTION_CHECK_PARAMETERS) && isSingleVariable && !this.skipParameterDeclaration && !Lint.hasModifier(node.modifiers, ts.SyntaxKind.PublicKeyword)) {
