...
var TypedefWalker = (function(_super) {
  ...
  TypedefWalker.prototype.visitParameterDeclaration = function(node) {
    if (node.type == null || node.type.kind !== ts.SyntaxKind.StringLiteral) {
      var optionName = node.parent.kind === ts.SyntaxKind.ArrowFunction ? "arrow-parameter" : "parameter";
  ...
  TypedefWalker.prototype.visitVariableDeclaration = function(node) {
    if (node.parent != null && node.parent.parent != null && node.parent.kind !== ts.SyntaxKind.CatchClause && node.parent.parent.kind !== ts.SyntaxKind.ForInStatement && node.parent.parent.kind !== ts.SyntaxKind.ForOfStatement) {
