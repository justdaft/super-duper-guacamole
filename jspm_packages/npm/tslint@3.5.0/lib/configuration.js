...
(function(process) {
  ...
  function findConfigurationPath(suppliedConfigFilePath, inputFilePath) {
    if (suppliedConfigFilePath != null) {
      ...
      var configFilePath = findup("package.json", {
        cwd: inputFilePath,
        nocase: true
      });
      ...
      configFilePath = findup(exports.CONFIG_FILENAME, {
        cwd: inputFilePath,
        nocase: true
      });
  ...
  function getRulesDirectories(directories, relativeTo) {
    ...
    if (directories != null) {
      if (typeof directories === "string") {
        ...
        rulesDirectories = directories.map(function(dir) {
          return getRelativePath(dir, relativeTo);
        });
      }
    }
    for (var _i = 0,
        rulesDirectories_1 = rulesDirectories; _i < rulesDirectories_1.length; _i++) {
